...
万用表一搭，物证也到位了：3.3V 的轨，实测压根不到 3.3——案发现场，电压塌着。

动机、手法、物证，全对得上：供电不行，电压被拉趴，复位，再来一遍。人赃并获，当场结案。
...
那当时实测塌着的电压轨呢？也是真的。弱 LDO 连 ROM 循环加 USB 枚举这点负载都压不太住，轨塌了——但塌归塌，还没塌到芯片活不下去，叮咚一声没落下。也就是说，第一话抓的不是无辜者，是个共犯：罪名成立，主犯另有其人。重启的元凶从头到尾是空片，换 LDO 把轨修稳了，主犯才单独现形。
