...
description: "最近使用了大企鹅的域名邮箱，毕竟大企业稳定一点。但是由于我使用了CDN加速，给域名做MX记录的时候却提示MX与CNAME冲突，这是为什么呢？ 原来大部分加速服务提供的都是CNAME模式，MX企业邮件记录也必须配置到同一个节点下。而CNAME资源记录出现在一个域名节点，为了确保不会"
publishDate: "2016-02-05T06:00:23Z"
tags: []
