...
description: "早上一个 uni app cli 项目 npm install 报错，定位到 node sass 。 一开始以为是 node gyp 的错，因为报错信息有一句 Try to update node gyp ，但是仔细一看是一个叫 win32 x64 88 binding.node"
publishDate: "2020-10-29T07:05:34Z"
tags: []
---
