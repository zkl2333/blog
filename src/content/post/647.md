---
title: "公开我的友链模板"
description: "最近折腾博客，结交了许多站长朋友。交换友链自然是必不可少，所以我依靠baidu和Google搜索了一些友链页面的示例，修修改改做出了一个像样的友链页面。 当初版本1.0是按照 我是链接 的方法制作的，在WordPress的链接管理器的备注一栏填写站长的邮箱即可调用头像 但是交换友"
publishDate: "2016-04-11T13:09:13Z"
tags: []
